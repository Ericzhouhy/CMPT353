...
def main():
    ...
    knn_convert_model = make_pipeline(FunctionTransformer(rgb2lab),KNeighborsClassifier())
    ...
    rf_convert_model = make_pipeline(FunctionTransformer(rgb2lab),RandomForestClassifier())
