...
def main():
    ...
    points = get_data("C:/Users/ericz/Desktop/CMPT353/e3/walk1.gpx").set_index('datetime')
    sensor_data = pd.read_csv("C:/Users/ericz/Desktop/CMPT353/e3/walk1.csv", parse_dates=['datetime']).set_index('datetime')
